...
public class Odometry {
    ...
    private final double ODOM_INCHES_PER_COUNT   = 0.0019968609; //0.002969;   //  GoBilda Odometry Pod (1/226.8)
    ...
    private static final double DRIVE_GAIN          = 0.0008;    // Strength of axial position control
    ...
    private static final double STRAFE_GAIN         = 0.0008;    // Strength of lateral position control
    ...
    private static final double YAW_GAIN            = 0.0005;    // Strength of Yaw position control
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        giro = myOpMode.hardwareMap.get(IMU.class, "imu");
        ...
        giro.initialize(new IMU.Parameters(orientationOnRobot));
    ...
    public boolean readSensors() {
        ...
        YawPitchRollAngles orientation = giro.getRobotYawPitchRollAngles();
        AngularVelocity angularVelocity = giro.getRobotAngularVelocity(AngleUnit.DEGREES);
